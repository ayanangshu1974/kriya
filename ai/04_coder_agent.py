...
# def create_environment(requirement_file: str = "requirements.txt"):
#     """
#     Creates a Python virtual environment and installs dependencies from requirements.txt. 
#     The requirements.txt has json content generated by builder_agent.py. So the cmd to install the dependencies
#     should be run after parsing the json and creating a proper requirements.txt file.
#     """
...
#     os.system(f"{activate_script} && pip install --upgrade pip")
